...
public class AddFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        title = view.findViewById(R.id.problem_title);
        des = view.findViewById(R.id.problem_des);
        image = view.findViewById(R.id.post_image);
        upload = view.findViewById(R.id.publish_button);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (imageuri == null) {
                    ...
                    uploadData(titl, description,latitude,longitude);
                }
        ...
        datadp.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(AddFragment.this).load(dp).into(account);
            }
    ...
    private void uploadData(final String titl, final String description, final String latitude, final String longitude) {
        ...
        Toast.makeText(getContext(), "Entered in onSuccess", Toast.LENGTH_SHORT).show();
        ...
        storageReference1.putBytes(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    databaseReference.child(timestamp).setValue(hashMap)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    pd.dismiss();
                                    Toast.makeText(getContext(), "Failed in 1", Toast.LENGTH_LONG).show();
                                }
                            });
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(getContext(), "Failed in 2", Toast.LENGTH_LONG).show();
            }
        });
    }
